...
public class UserController implements Serializable {
    ...
    public String seConnnecter() {
        ...
        if (res == 1) {
            ...
            ejbFacade.initBudgetEntiteAdministratifItems(selected);
            compteFacade.initComptes();
            System.out.println("haaa user : " + SessionUtil.getConnectedUser().getLogin());
            System.out.println("haaa faculte :" + SessionUtil.getCurrentFaculte().getNom());
            System.out.println("haaa entite administratif" + SessionUtil.getCurrentEntiteAdministratif());
            System.out.println("haaa list entite administratifs" + SessionUtil.getAllEntiteAdministratifs());
            System.out.println("haaa budget facultes" + SessionUtil.getCurrentBudgetFacultes());
            System.out.println("haaa les comptes" + SessionUtil.getComptes());
            System.out.println("haaa les comptes item" + SessionUtil.getCurrentCompteItems());
            return "/compte/List?faces-redirect=true";
        }
        showErrors(res);
        return null;
    ...
    private void showErrors(int res) {
